...
print("<tr><td align=left><a href=userdetails.php?id=$arr[id]><b>$arr[username]</b></a>" .($arr["donor"] =="yes" ? "<img src=pic/star.png border=0 alt='Donor'>" : "")."</td>
...
if ((!ur::cstaff()) AND get_user_class() >= UC_ADMINISTRATOR) {
