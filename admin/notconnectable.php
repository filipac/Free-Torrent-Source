...
print("<p align=center><b>All Peers Are Connectable! biggrin.gif</b></p>\n");
else
{
...
sql_query("INSERT INTO messages (sender, receiver, added, msg) VALUES (0,$dat[userid] , '" . get_date_time() . "', " . sqlesc($msg) .")") or sqlerr(__FILE__,__LINE__);
}
