  ...
  else
  {
    ...
    while ($user = mysql_fetch_array($res))
    {
      ...
      $n_comments = $n[0];
    	...
    	echo "<tr><td><b><a href='$BASEURL/userdetails.php?id=" . $user['id'] . "'>" .
      		$user['username']."</a></b>" . get_user_icons($user) . "</td>" .
//      		($user["donor"] == "yes" ? "<img src=pic/star.png alt=\"Donor\">" : "") .
//					($user["warned"] == "yes" ? "<img src=\"pic/warning.png\" alt=\"Warned\">" : "") . "</td>
