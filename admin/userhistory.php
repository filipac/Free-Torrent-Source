...
if ((!ur::cstaff()) AND get_user_class()< UC_POWER_USER || ($CURUSER["id"] != $userid && get_user_class() < UC_MODERATOR))
...
if ($action == "viewposts")
{
	...
	if (mysql_num_rows($res) == 1)
	{
	  ...
	  $subject = "<a href=userdetails.php?id=$userid><b><font color=black>$arr[username]</font></b></a>" . get_user_icons($arr, true);
	}
	else
...
if ($action == "viewcomments")
{
    ...
    $page_url = $comm_page?"&page=$comm_page":"";
	  ...
	  "&nbsp;---&nbsp;<b>Comment:&nbsp;</b>#<a href=details.php?id=$torrentid&tocomm=1&hit=1$page_url>$commentid</a>
	  </td></tr></table></p>\n");
