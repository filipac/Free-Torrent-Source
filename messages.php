...
<TD width="1%" class="colhead">Delete</TD>
</TR>
<?php
if ($mailbox != PM_SENTBOX)
{
$res = sql_query('SELECT * FROM messages WHERE receiver=' . sqlesc($CURUSER['id']) . ' AND location=' . sqlesc($mailbox) . ' ORDER BY id DESC') or
...
{
echo("<TR>\n<TD ><IMG src=\"pic/unreadpm.gif\" width=\"35\" height=\"22\" alt=\"Unread\"></TD>\n");
}
else
{
echo("<TR>\n<TD><IMG src=\"pic/readpm.gif\" width=\"35\" height=\"22\" alt=\"Read\"></TD>\n");
}
...
?>
<TR class="colhead">
<TD colspan="5" align="right" class="colhead"><INPUT type="submit" name="move" value="Move to"> <SELECT name="box">
    <OPTION value="1">Inbox</OPTION>
      ...
      ?>
        ...
        </SELECT> or <INPUT type="button" value="Check all" onClick="this.value=check(form)"><input type="submit" name="delete" value="Delete">
      </TD>
    </TR>
  
  </FORM><tr><td colspan=5>
<DIV align="left"><IMG src="pic/unreadpm.gif" width="35" height="22" alt="Unread" /> Unread Messages.<br>
<IMG src="pic/readpm.gif" width="35" height="22" alt="Read" /> Read Messages.</DIV>
...
<INPUT type="submit" value="Forward" class="but"></TD>
</TR>
</TABLE>
</FORM><?php
stdfoot();
...
sql_query("INSERT INTO messages (poster, sender, receiver, added, subject, msg, location, saved) VALUES(" . $CURUSER["id"] . ", " .
...
{
++$box;
sql_query("INSERT INTO pmboxes (userid, name, boxnumber) VALUES (" . sqlesc($CURUSER['id']) . ", " . sqlesc($name1) . ", $box)") or
...
{
++$box;
sql_query("INSERT INTO pmboxes (userid, name, boxnumber) VALUES (" . sqlesc($CURUSER['id']) . ", " . sqlesc($name2) . ", $box)") or
...
{
++$box;
sql_query("INSERT INTO pmboxes (userid, name, boxnumber) VALUES (" . sqlesc($CURUSER['id']) . ", " . sqlesc($name3) . ", $box)") or
