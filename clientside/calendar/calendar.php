...
class DHTML_Calendar {
    ...
    function DHTML_Calendar($name='calendar',
							$calendar_lib_path = '/clientside/calendar/',
                            $lang              = 'en',
    ...
    function make_input_field($cal_options = array(), $field_attributes = array()) {
        ...
        $ret.= '<a href="#" id="'. $this->_trigger_id($id) . '">' .
            '<img align="absmiddle" border="0" src="pic/img.gif" alt="" /></a>';
